                    ...
                    <div class="px-4 py-3 my-6 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                        ...
                        <form action="" method="post">
                            <label class="block text-sm">
                                <span class="text-gray-700 font-bold dark:text-gray-400">Nomor Agenda</span>
                                <input type="text" name="nomor_agenda" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" autocomplete="off" required />
                            </label><br>
